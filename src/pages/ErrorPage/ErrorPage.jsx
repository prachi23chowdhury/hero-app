...
const ErrorPage = () => {
  ...
  return (
    <div>
        <Navbar></Navbar>
        <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 px-5 text-center">
      <img src={errorImage} alt="404 Error" className="w-80 md:w-96 mb-6" />
      ...
      <button
        onClick={() => navigate(-1)}
        className="bg-purple-600 text-white font-semibold px-6 py-2 rounded-xl
